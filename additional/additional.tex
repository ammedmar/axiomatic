...
We write $\mu$ for the multiplication of $\Lambda_n$.
...
\begin{enumerate}
	\item The primitively generated exterior Hopf algebra is self-dual: the monomial basis is dual to itself, and under the resulting identification of $\Lambda_n$ with its dual the multiplication $\mu$ and the partition coproduct $\Delta$ are adjoint.
