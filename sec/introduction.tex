...
This remains true when the non-vanishing axiom is strengthened to non-degeneracy, the counterexample in this case being built from a mod~$2$ Pascal transform.
Second, we prove that irreducibility alone forces compatibility with degeneracy maps: every irreducible semi-simplicial \mbox{cup-$i$} construction is simplicial, so the semi-simplicial and simplicial classification problems coincide.
