...
The importance of effective constructions is also highlighted by their use in topological data analysis, where cup-$i$ products have been used to extract finer features of real-world data using the open-source project \href{https://github.com/Steenroder/steenroder}{\texttt{steenroder}}.
