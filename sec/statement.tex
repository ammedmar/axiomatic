...
\begin{theorem} \label{t:main}
	There is up to isomorphism only one free non-degenerate irreducible \mbox{cup-$i$} construction.
\end{theorem}
...
To prove our main result we will use formulas defining one such \mbox{cup-$i$} construction introduced in \cite{medina2021fast_sq} which we now reviewed.
...
\cref{t:existence} states that it is non-degenerate, irreducible, and free; and \cref{t:steenrod cup-i} that it is equal to Steenrod's original cup-$i$ construction.

%We also have, as proven in \cref{ss:free non-deg irreducible}, that the following.
%
