...
A semi-simplicial \mbox{cup-$i$} construction is said to be \textbf{irreducible} if for any simplex $x$ in $X$
\[
\boxed{\Big( y^{(1)} \cup_{i} y^{(2)} \Big)(x) = 0}
\]
whenever $y$ is a proper face of $x$ and $y^{(1)}$ and $y^{(2)}$ are faces of $y$.
It is \textbf{free} if for any two simplices $x$ and $x'$ in $X$
\[
