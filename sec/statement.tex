...
The identity obtained by setting $i = 1$ implies that the product induced by $\cup_0$ in the homology $HA$ of $A$ is commutative, with $\cup_1$ enforcing this relation at the chain level.
...
The first axiom alluded to in the introduction, naturality, has been explicitly included in our definition of (semi-)simplicial \mbox{cup-$i$} construction; whereas the second, minimality, is manifested in the use of $W$ instead of an arbitrary resolution of $\F$ as \(\F[\Sym_2]\)-module.
