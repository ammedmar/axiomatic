...
This section provides a category theoretic perspective on the notion of cup-$i$ construction using the functor of chains with mod 2 coefficients.
...
\subsection{Axioms dually described}\label{ss:properties}
