...
Since the defining identities are linear (\cref{ss:linearity}), the collection of irreducible semi-simplicial \mbox{cup-$i$} constructions defined on simplices of dimension at most $N$ forms an $\F$-vector space.
