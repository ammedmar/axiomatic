...
%	\bd \! \sum_{\P_{n-i}(n)} \delta_{U}\ =\ \sum_{k = 0}^{i} \sum_{\P_{n-i}(n)} \delta_{U} \delta_k \ = \sum_{\P_{n-i}(n)} \sum_{u \not\in U} \delta_{u.U}
%	\end{equation}
...
%	\sum_{(u, V) \in S_1} \delta_{V^\xi}\delta_u \ot \delta_{V^{\bar{\xi}}}\delta_u \ \, =
...
%	\[
%	\delta_{V^\xi} \delta_u \ot \delta_{V^{\bar{\xi}}} \delta_u =
%	\begin{cases}
