...
\]
provided by the linearity observations closing \cref{ss:axioms_revisited}.
...
\begin{proof}
	The defining identity of \cref{ss:naturality} at $(i_0, n)$ reduces to the second hypothesis, the one at $(i_0+1, n)$ to the first, and all others hold trivially.
\end{proof}
...
In this subsection we construct a column $\Theta$ at $0$ such that $\canonical + \Theta$, provided by \cref{ss:axioms_revisited,ss:columns}, is non-degenerate, irreducible, and not free.
We use the coefficient notation $\coeff{\zeta}{V \ot W}$ of \cref{ss:axioms_revisited}.
...
\begin{proof}
	...
	\medskip
	\textit{Conclusion.}
	By \cref{ss:axioms_revisited,ss:columns}, $\widetilde\triangle := \canonical + \Theta$ is a semi-simplicial \mbox{cup-$i$} construction.
