...
\section{Other formulas of cup-$i$ products}\label{s:others}
...
\begin{remark*}
	A recursive formula for Steenrod's original construction, which seems to first appear in \cite{medina2022dennis}, is:
...
an alternative formulas for a \mbox{cup-$i$} construction were introduced based on the Alexander--Whitney and Eilenberg--Zilber linear natural transformations
\[
