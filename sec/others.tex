...
\begin{proof}
	...
	The vertices of the right hand side of the first identity smaller than $q_{r+1}$ are those of $[q_1, \dots, q_2] \ast \cdots \ast [q_{r-1}, \dots, q_r]$, namely $0, \dots, r-1$.
