...
an alternative cup-$i$ construction was developed based on the Alexander--Whitney and Eilenberg--Zilber linear natural transformations
\[
...
\subsection{Operads and props} \label{ss:operads}
