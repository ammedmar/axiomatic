...
\colorlet{DefinitionGreen}{ForestGreen!100!black}
\newcommand{\defn}[1]{{\color{DefinitionGreen}\emph{#1}}}

% comments
\newcommand{\anibal}[1]{\todo[Anibal\!]{#1}}
\newcommand{\codex}[1]{\todo[Codex\!]{#1}}
\newcommand{\TBW}{\noindent TBW\todo{TBW}}
